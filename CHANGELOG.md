...
- Windows: the site is the Windows surface in this release. Native Windows recorder is not in the zip.

## 1.0.0

First native macOS recorder: one display, draggable camera bubble, 3-2-1 countdown, named Desktop MP4s.
